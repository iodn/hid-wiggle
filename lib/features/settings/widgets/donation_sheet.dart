...
class _DonationSheetState extends State<DonationSheet> {
  ...
  String _buildShareText({required bool isBtc, _DonationFocus? focus}) {
    ...
    return ''
        'Support HIDWiggle - Open Source USB HID Tool\n'
        '$focusLine'
        '$chainLine'
        '$addrLine'
        'Repo: ${widget.repoUrl}\n';
  ...
  Future<void> _openLiberapay() async {
    ...
    try {
      ...
      if (mounted) setState(() => _liberapayLoading = false);
    }
  }
  ...
  Future<void> _thankYou() async {
    ...
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Your support means the world! Every donation helps keep HIDWiggle free, fast, and actively maintained. Thank you for believing in open-source software.',
